$(document).ready(function () {
    ...
    $("#lista-capacitacion-validar").on("click", "#ver_archivo_pdf", function () {
        ...
        var url = urlProyectoDescargaPdf
    ...
    $("#lista-capacitacion-validar").on("change", "#accion_revisar", function () {
    ...
    $("#lista-capacitacion-validar").on("click", ".v-acta", function () {
        ...
        var url = urlVerActa
            ...
            .replace("capacitacion_id", capacitacion_id);
    ...
    $("#lista-capacitacion-validar").on("click", ".enviar-correo-mod",
        function () {
            const id = $(this).attr("data-id");
            const id_modulo = $(this).attr("data-modulo");
            var url = urlEnviaCertificadoCorreoMod
                .replace("999999999", id)
                .replace("888888888", id_modulo);
            swal({
                title: "Importante",
                ...
                .then(function () {
                    $(`#lista-capacitacion-validar .evm-${id_modulo}`).html(
                        "Enviando...."
                    );
                    $.ajax({
                        url: url,
